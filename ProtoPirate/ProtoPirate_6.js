/**
 * ProtoPirate - Car Key Decoder for Bruce Firmware 1.4+
 * v1.0.0 - Full feature parity with original ProtoPirate (C/Flipper)
...
function drawCarouselMenu() {
    ...
    setTextSize(1); setTextColor(GRAY);
    drawString("v1.0", screenWidth - 28, 6);
    drawFillRect(0, 20, screenWidth, 1, GRAY);
...
setTextSize(1); setTextColor(GRAY);
var verStr = "Car Key Decoder v1.0.0";
